...
def initialize_robots(arena_size=-1, particle_box=-1): # particle_box: size of the robot enclosed in a square
    ...
    robots = []
    robots.append(robot_wanderer.Robot_player(50, y_center, 180, name="Second robot", team="Team Wander"))
    robots.append(robot_wanderer.Robot_player(90, y_center, 180, name="Second robot", team="Team Wander"))
    robots.append(robot_braitenberg_hateBot.Robot_player(4, y_center, 0, name="My Robot", team="A"))
    return robots
