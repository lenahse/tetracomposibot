...
def initialize_robots(arena_size=-1, particle_box=-1): # particle_box: size of the robot enclosed in a square
    ...
    robots = []
    robots.append(robot_wanderer.Robot_player(93, y_center, 170, name="Second robot", team="Team Wander"))
    robots.append(robot_wanderer.Robot_player(23, y_center, 170, name="Second robot", team="Team Wander"))
    robots.append(robot_braitenberg_loveBot.Robot_player(4, y_center, 0, name="My Robot", team="A"))
    return robots
